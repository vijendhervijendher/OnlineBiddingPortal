...
public class header {
    ...
    public static String DBstring = "onlineBidding";
    ...
    public static final String Microserviceurl = "http://localhost:8090/microservice";
    ...
    public static final String Checkouturl =  "checkout";
    ...
    //memcached strings keys
    
    public static String  memcached_catalogue_key = "{}";
